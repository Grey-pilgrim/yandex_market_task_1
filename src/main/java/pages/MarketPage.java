...
public class MarketPage extends Page {
    ...
    public int calcElements() {
        return DRIVER.findElements(By.xpath("//div[contains(@class, 'n-snippet-list')]//div[@class='n-snippet-card2__title']//a")).size();
    }

    public String getFirstElement() {
        return DRIVER.findElements(By.xpath("//div[contains(@class, 'n-snippet-list')]//div[@class='n-snippet-card2__title']//a")).get(1).getText();
    }
