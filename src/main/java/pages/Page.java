...
public abstract class Page {
    ...
    public static Map<String, String> locators = new HashMap<String, String>() {{
        ...
        put("Телевизоры", "//html//div[@class='layout-grid__col layout-grid__col_width_2']//div[3]/div[1]/a[1]");
        put("Цена", "//*[@id=\"glf-pricefrom-var\"]");
        put("Samsung", "//label[@class='checkbox__label' and contains(text(),'Samsung')]/ancestor::a[1]");
        put("LG", "//label[@class='checkbox__label' and contains(text(),'LG')]/ancestor::a[1]");
        ...
        put("Найти", "/html/body/div[1]/div[1]/noindex/div[2]/div/div[2]/div/div[1]/form/span[2]/button");
